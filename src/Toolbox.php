...
class Toolbox implements Serializable {
	 ...
	 * @param  mixed $value (Optional) If not present (or `null`), the current metadata is returned. If present, the metadata is created/updated
	 * @return mixed If not updating the metadata, the metadata (if any) currently stored
	 */
